...
const AddMovie = ({ pickMovie, setmovieList, movieList }) => {
  ...
  return (
    <>
      <Button
        sx={{ "&:hover": { backgroundColor: "rgb(43, 43, 43)" } }}
        onClick={handleOpen}
            ...
            <ThemeProvider theme={theme}>
              <TextField
                InputLabelProps={{
                  sx: {
                    color: "white",
                    [`&.${inputLabelClasses.shrink}`]: { color: "white" },
                  },
                }}
                label="Movie Name"
                variant="outlined"
              ...
              <TextField
                ...
                variant="outlined"
                onChange={(x) => setMovieDescription(x.target.value)}
              />
              <TextField
                InputLabelProps={{
                  sx: {
                ...
                label="Movie Poster"
                variant="outlined"
                onChange={(x) => setMoviePosterSrc(x.target.value)}
              />
              <TextField
                InputLabelProps={{
                  sx: {
                ...
                label="Movie Rating"
                variant="outlined"
                onChange={(x) => setMovieRating(x.target.value)}
              />
            </ThemeProvider>
          </Box>
          <Button
